...
public class WorkController {
	...
	//her is json body we need to give type and address object (after login customer is uploading the work)
	@PostMapping("/work")
	...
	//here vendor is starting his work so we only need to pass the ids in url no need of jasonbody
	@PutMapping("/start")
